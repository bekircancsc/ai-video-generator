...
export function buildScriptPrompt(brief: ScriptBrief) {
  return [
    ...
    "The first scene's `text` is printed large over the opening two seconds, before anyone has",
    "decided to stay: make it the strangest fact in the video, and make the first sentence of the",
    "first narration say that fact plainly. No scene-setting before it.",
